        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <img src="http://whoisict.com/html/js/libs/admin-lte/dist/img/user2-160x160.jpg" class="user-image" alt="User Image"/>
                    <span class="hidden-xs"><?=getLoginName()?></span>
                </a>
                <ul class="dropdown-menu">
                    <li class="user-header">
                        <img src="http://whoisict.com/html/js/libs/admin-lte/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image" />
                        <p>
