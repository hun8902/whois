...
class ThisPage extends Page {
	...
	function makeJavaScript() {
        $this->addScriptFile("//ajax.googleapis.com/ajax/libs/jqueryui/1.10.2/jquery-ui.min.js");
        $this->addScriptFile("http://whoisict.com/html/js/jquery.ui.plupload/plupload.full.min.js");
        $this->addScriptFile("http://whoisict.com/html/js/jquery.ui.plupload/jquery.ui.plupload.js");
        $this->addScriptFile("http://whoisict.com/html/js/jquery.ui.plupload/langs/ko.js");
        ...
        function setData(code) {
            ...
            var arrFile = ['avi','wmv','csv','xls','xlsx','doc','docx','html','mov','mp3','mp4','pdf','ppt','pptx','txt','xml','zip'];
            var image = '';
			$.ajax({
				url:'"._API_URL."',
				type:'post',
